...
metrics1 = {
    ...
    "regressor1_mean_squared_error": mean_squared_error(y_test, predictions_model1),
    "regressor1_mean_absolute_error": mean_absolute_error(y_test, predictions_model1),
}

metrics0 = {
    "regressor2_r2_score": r2_score(y_test, predictions_model0),
    "regressor2_mean_squared_error": mean_squared_error(y_test, predictions_model0),
    "regressor2_mean_absolute_error": mean_absolute_error(y_test, predictions_model0),
}
