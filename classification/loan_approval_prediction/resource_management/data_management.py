...
def create_blob_container(
    storage_client, storage_account_name, resource_group_name, container_name
):
...
def create_tabular_dataset(
    workspace, datastore, paths, dataset_name=None, dataset_description=None
):
...
def upload_folder(datastore, source_directory, target):
    ...
    """
    datastore.upload(
        src_dir=source_directory, target_path=target, overwrite=True
    )
