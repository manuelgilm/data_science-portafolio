...
st.markdown(
    "This is a simple Iris classifier that uses a Random Forest model to predict the species of an Iris flower based on its sepal and petal measurements."
)
# add local image
...
st.sidebar.markdown(
    "Please specify the different parameters of the Iris flower to get the prediction from the model."
)
